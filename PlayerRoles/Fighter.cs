...
//17:38 Eowen: Jednu supinu uz mas! Nejprve se ji zbav...

//Serial: 0x40316307  Position: 90.95.0  Flags: 0x0000  Color: 0x049B  Graphic: 0x1B72  Amount: 1  Layer: None Container: 0x4028E48C

//Serial: 0x40316307  Position: 0.0.0  Flags: 0x0000  Color: 0x049B  Graphic: 0x1B72  Amount: 0  Layer: LeftHand Container: 0x002CA264

//Serial: 0x4020C9D2  Position: 101.108.0  Flags: 0x0020  Color: 0x049B  Graphic: 0x0E28  Amount: 1  Layer: None Container: 0x4028E48C
    ...
    public List<UOItem> GetCurrentShields()
    {
      ...
      foreach (UOItem item in searchItems)
      {
        if (item.IsItemType(ItemLibrary.GoldenscaleShield))
        {
          if (!World.Player.Backpack.AllItems.FindType(0x0E28, 0x049B).Exist)//supina
            continue;
        }
    ...
    //,exec stayandfight 2 70 false true "1385.1491|1376.1490|1369.1498|1359.1500|1353.1488|1355.1469|1383.1472|1382.1454|1363.1447" "Wraith" 2

    //exec StayAndFight 6 70 false false "" "Skeleton (axe)" 2
    //---------------------------------------------------------------------------------------------
